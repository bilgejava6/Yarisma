...
import static com.muhammet.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.muhammet.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(YarismaException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(YarismaException exception){
